...
# python3 draw_figure.py -fn "/Users/zakaahmedchishti/Documents/GitHub/se-cloud-2023-2024/MyWork_Exerices/neocortexapi/Results/Spatial Pooler Stability/ActiveColumns_MaxBoost_5_MinOverl_1_4_plotly-input.csv" -gn Digit_4 -mc 1000 -ht 15 -yt column -xt cycle -st singlecolumn -fign CortialColumn        
...
parser.add_argument('sampleOne.txt', '-fn',help='Filename from which data is supposed to be red', required=True)
parser.add_argument(
