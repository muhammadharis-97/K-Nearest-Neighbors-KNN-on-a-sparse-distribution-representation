...
namespace KNNUnitTest
{
    ...
    public class UnitTest
    {
        ...
        [TestMethod]
        public void TestKNNClassifier_KisgreaterthentraingFeature()
        {
            // Test Case to Handle when K is greater tha trainingFeature lists length 
            K = 100;
            if (K > trainingFeatures.Count)
            {
                // If K is greater than trainingFeature lists length
                // Act & Assert
        ...
        [TestMethod]
        public void TestKNNClassifier_unknownfeatureortrainingfeatureisnull()
        {
        ...
        [TestMethod]
        public void TestKNNClassifier_traingFeatureisnull()
        {
            // Test Case to Handle when K is greater tha trainingFeature lists length 
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() =>
            {
                 kNNClassifier.Classifier(unknownFeature, null, trainingLabels, K);
             });
